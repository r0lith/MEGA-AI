...
let handler = async (m, { conn, usedPrefix, command }) => {
    ...
    let pp = await conn.profilePictureUrl(who, 'image').catch(_ => 'https://i.ibb.co/6nj2Hts/spank.jpg')
    let me = await conn.profilePictureUrl(m.sender, 'image').catch(_ => 'https://i.ibb.co/6nj2Hts/spank.jpg')
